      ...
      <CardContent className={cn("flex flex-col justify-center items-center gap-4")}>
        <Card className="w-[90%] lg:w-[70%] rounded-xl bg-green-100 border-4 border-green-200">
          ...
          <CardContent className="flex flex-col gap-4">
            <h2>Nếu bạn đăng ký nhận tin tức, chúng tôi sẽ gửi email thông báo cho bạn khi có ai đó đăng tin gần khu vực của bạn.</h2>
            <p> - Địa chỉ nhận tin sẽ là email đăng ký hệ thống của bạn, nếu bạn đăng nhập bằng bên thứ 3 như Google, Facebook thì chúng tôi sẽ gửi đến địa chỉ email do Google, Facebook cung cấp.</p>
            <p> - Những tin cùng thành phố với bạn sẽ được gửi cho bạn.</p>
            <p> - Chúng tôi không khuyến khích đăng nhập với bên thứ 3 như Google, Facebook.</p>
          </CardContent>

          <div className="w-full flex justify-center items-center">
            <Separator className={cn("w-full border-2 border-green-200 mb-4 bg-green-200")} />
          </div>

          <CardFooter className="flex items-center gap-1">
            <p>Bạn có thể thay đổi địa chỉ của bạn tại</p>
            <p className="underline cursor-pointer" onClick={() => navigate("/update-info")}>đây</p>
          </CardFooter>
        </Card>
